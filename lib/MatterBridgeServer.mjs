...
export default class MatterBridgeServer {
  ...
  constructor({
    ...
    this.__initDeviceQueue = new PQueue({ concurrency: 1 });
    this.__uninitDeviceQueue = new PQueue({ concurrency: 1 });
  ...
  async __initDevice(device) {
    return this.__initDeviceQueue.add(async () => {
  ...
  async __uninitDevice(device) {
    return this.__uninitDeviceQueue.add(async () => {
  ...
  pauseQueues() {
    this.__initDeviceQueue.pause();
    this.__uninitDeviceQueue.pause();
  }

  resumeQueues() {
    this.__initDeviceQueue.start();
    this.__uninitDeviceQueue.start();
  }
